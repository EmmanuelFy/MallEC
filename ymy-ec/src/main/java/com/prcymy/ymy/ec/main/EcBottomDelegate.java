...
import com.prcymy.ymy.ec.main.cart.ShopCartDelegate;
...
public class EcBottomDelegate extends BaseBottomDelegate {
    ...
    public LinkedHashMap<BottomBean, BottomItemDelegate> setItems(ItemBuilder builder) {
        ...
        items.put(new BottomBean(R.drawable.all_shopping_cart_nor_ic,"购物车"),new ShopCartDelegate());
        items.put(new BottomBean(R.drawable.mainpage_person_nor_ic,"我的"),new PersonalDelegate());
